...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-github-test12](https://github.com/rhdh-JslYoon-org/audio-to-text-github-test12)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/audio-to-text-github-test12-gitops](https://github.com/rhdh-JslYoon-org/audio-to-text-github-test12-gitops)

# **Usage**

To access the audio-to-text-github-test12 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of audio-to-text-github-test12. You can access this namespace through the web console or via your CLI.
