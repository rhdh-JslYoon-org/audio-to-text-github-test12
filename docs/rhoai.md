...
2) Go to the `Data Science Projects` section and access your application's project named `audio-to-text-github-test12`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `audio-to-text-github-test12-notebook`.
...
5) In the terminal, run `cd audio-to-text-github-test12` to navigate to your sample app's directory.
